...
export const MEMBERSHIP_PURCHASES_COLLECTION_ID = process.env.NEXT_PUBLIC_APPWRITE_MEMBERSHIP_PURCHASES_COLLECTION_ID || '';
export const PENDING_TRANSFERS_COLLECTION_ID = process.env.NEXT_PUBLIC_APPWRITE_PENDING_TRANSFERS_COLLECTION_ID || '';
