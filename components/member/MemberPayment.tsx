    ...
    try {
      ...
      await databases.createDocument(
        ...
        'unique()',
        {
          ...
          paymentModelUsed: organization.paymentModel
        }
      );
        ...
        <div className="space-y-4">
          <div className="bg-primary/10 p-4 rounded-md">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              {plan.intervalDescription || 'One-time payment'}
            </p>
          </div>
        ...
        {user ? (
          paystackKey ? (
            ...
            <div className="w-full text-center text-amber-600 p-3 bg-amber-50 rounded-md">
              ...
              <p className="text-sm">
                Payment is currently unavailable for this organization.
                Please try again later or contact the organization.
              </p>
            </div>
          )
        ) : (
          <Button className="w-full" asChild>
            <a href={`/login?redirectTo=/member-portal/${organizationId}/plans`}>
              Log in to continue
            </a>
          </Button>
        )}
