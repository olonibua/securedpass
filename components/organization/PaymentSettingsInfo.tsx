        ...
        {paymentModel === "subscription" ? (
          <div className="space-y-4">
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-md">
              ...
              <p className="text-sm mt-2">
                You pay a subscription fee to use our platform, and you collect
                100% of your member payments directly through your Paystack
                account.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <ol className="list-decimal list-inside space-y-1 text-sm pl-2">
                ...
                <li>
                  Your members pay you directly through your Paystack account
                </li>
          ...
          <div className="space-y-4">
            <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-md">
              ...
              <p className="text-sm mt-2">
                You pay no subscription fee, but SecuredPass takes a{" "}
                {transactionFeePercentage}% fee from each payment made by your
                members.
              </p>
            </div>
            <div className="space-y-2">
              ...
              <ol className="list-decimal list-inside space-y-1 text-sm pl-2">
                ...
                <li>
                  Your members pay through our platform&apos;s Paystack account
                </li>
                <li>
                  We deduct a {transactionFeePercentage}% fee from each
                  transaction
                </li>
            ...
            <div className="mt-4 border-t pt-4">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Please contact support to set up your bank account for
